...
public class Cart extends AppCompatActivity implements AdapterView.OnItemClickListener,JsonResponse{
    ListView l1;
...
//                l1.setAdapter(ar);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        final CharSequence[] items = {"Total Payable"+" "+total[position],"Make Payment","Cancel"};
