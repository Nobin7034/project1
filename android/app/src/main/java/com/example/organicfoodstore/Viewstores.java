...
public class Viewstores extends AppCompatActivity implements JsonResponse,AdapterView.OnItemClickListener {
    ListView l1;
    String[] storename,buldingname,place,phone,email,image,value,store_id;
    TextToSpeech textToSpeech;
    public static String textToSpeak, storeid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JR.json_response = (JsonResponse) Viewstores.this;
        String q = "/viewoutputs?id="+Login.logid;
        q = q.replace(" ", "%20");
        JR.execute(q);
    ...
    public void response(JSONObject jo) {
        try {
            ...
            if (status.equalsIgnoreCase("success")) {
                ...
                buldingname = new String[ja1.length()];
...
//                value = new String[ja1.length()];
                ...
                for (int i = 0; i < ja1.length(); i++) {
                    ...
                    buldingname[i] = ja1.getJSONObject(i).getString("building_name");
...
//                l1.setAdapter(ar);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        storeid=store_id[position];
        final CharSequence[] items = {"View Items","Cancel"};
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                if (items[item].equals("View Items")) {
